...
import { TransactionProfileModalController } from "./transaction.profile.modal.controller.class.js";

export class TransactionMainModal extends Modal{
	...
	constructor ( modalData ){
		...
		this.tabs = {
			'transactionprofile' : {
				obj : ( ) => {
					return new TransactionProfileModalController({
						modalID :  "transaction-profile-tab",
						controllerName : "transactionprofilecontroller",
						template : "/inventory/sources/templates/modal/transaction.profile.modal.html",
						parent : this,
	...
	constructs(){
		this.navigate ({navigate:'transactionprofile'});
	}
